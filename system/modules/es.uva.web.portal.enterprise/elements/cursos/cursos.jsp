...
squery.setResourceTypes(new String[]{"cursos"});
...
try {
	...
	for (CmsSearchResource sr : results) {
		...
		if (sr.getField("campo.tipo_prop")!= null && !sr.getField("campo.tipo_prop").isEmpty()) {
			int tipo=Integer.parseInt(sr.getField("campo.tipo_prop"));
			tipo=tipo+4; //Para que empiece en 5
			//Modifico el tipo par que no choque con los estudios
			ele.put("campo.tipo_prop", (Object)tipo);
		}
