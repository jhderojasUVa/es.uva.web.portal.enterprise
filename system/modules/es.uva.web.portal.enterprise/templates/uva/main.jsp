...
<html lang="${cms.locale}" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <img alt="Universidad de Valladolid" src="<cms:link>/sites/uva/img/logo_uva.png</cms:link>" />
        </div>
        <div class="col-md-9">
    ...
    <div class="container">
		<div class="row">
            ...
            <div class="col-md-12 d-block d-sm-none">
              ...
              <!--
              <nav>
                <uva-navegacion-vertical id="navegacion" data="<cms:link>/sites/uva/ws/menu.jsp</cms:link>" uri="/" startLevel="0" levels=2 onlyone="true" locale="es" />
              </nav>
            -->
            </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<uva-navegacion-breadcrumb 	id="breadcrumb" data="<cms:link>/sites/uva/ws/menu.jsp</cms:link>" uri="${cms.requestContext.uri}" startLevel="2" locale="es" />
			</div>
		</div>
	</div>
	<!-- cuerpo -->
	<div class="container" style="margin-bottom: 20px;">
		<div class="row" class="parche_tuti">
			<aside id="navegacion_lateral" class="col-md-3 hidden-xs hidden-sm">
				<uva-navegacion-vertical id="navegacion" data="<cms:link>/sites/uva/ws/menu.jsp</cms:link>" uri="${cms.requestContext.uri}" startLevel="2" onlyone="true" locale="es" />
