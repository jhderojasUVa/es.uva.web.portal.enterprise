<%@page buffer="none" session="false" trimDirectiveWhitespaces="true" import="java.net.InetAddress,java.util.Date" %><%--
--%><%@ taglib prefix="cms" uri="http://www.opencms.org/taglib/cms" %><%--
--%><%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %><%--
--%><%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %><%--
--%><%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><%--
--%><%@ page import="com.alkacon.opencms.v8.weboptimization.*" %><%--
...
<html lang="${cms.locale}" dir="ltr">
  <head>
	...
	<!-- <script src="<cms:link>/resources/uva4/js/menu.js</cms:link>"></script> NO PARA ESTE TIPO DE MENU -->
  ...
  <body>
	<c:if test="${cms.isEditMode}">
		...
		<div style="background: lightgray; height: 65px">&nbsp;</div>
	</c:if>
	<!-- HEADER -->
	  ...
	  <div class="container">
		<div class="row align-items-center">
				...
				<span class="separador_left">
					...
					<c:forEach var="locale" items="${cms.availableLocales}">
						<c:choose>
							...
							<%-- <option selected value="<cms:link locale='${locale}'>${cms.requestContext.uri}</cms:link>">${locale}</option>--%>
							<%--<a href="#"><span class="text-menu">${locale}${' '}</span></a>--%>
							</c:when>
							<c:otherwise>
							<option value="${locale}">${locale}</option>
							<%--<option value="<cms:link locale='${locale}'>${cms.requestContext.uri}</cms:link>">${locale}</option>--%>
							<%--<a href="<cms:link locale='${locale}'>${cms.requestContext.uri}</cms:link>"><span class="text-menu">${locale}</span></a>--%>
							</c:otherwise>
						</c:choose>
					</c:forEach>
		  ...
		  <div class="col-md-2 text-right">
			<a href="http://directorio.uva.es" target="_blank">
				<span class="separador_left"><span class="text-menu" data-i18n-en="Directory">Directorio</span> <i class="far fa-address-card"></i></span>
			</a>
		  </div>
		  <div class="col-md-2 text-right">
		  	<a href="http://miportal.uva.es" target="_blank">
				<span class="separador_left"><span class="text-menu" data-i18n-en="I'm UVa">Soy UVa</span> <i class="fas fa-lock"></i></span>
			</a>
		  </div>
	...
	<div class="container noticias" style="margin-top: 20px;">
      <div class="row">
	...
	<script src="/resources/uva4/js/noticias.js"></script>
	...
	<script src="/system/modules/es.uva.web.portal.enterprise/resources/uva4/js/agenda.js"></script>
    <script>
      // Slideshow options
      var agendaoptions = {
        slideIndex: 0,
      ...
      <div class="row" style="margin-top: 10px;">
        <div class="col-md-2">
          <nav class="nav flex-column">
            ...
            <a class="nav-link tab azul_blanco" data-i18n-es="TITULOS PROPIOS" data-i18n-en="OWN TITLES" id="btnTitulos">TITULOS POPIOS</a>
            <a class="nav-link tab azul_blanco" data-i18n-es="FORMACIÓN CONTINUA" data-i18n-en="CONTINOUS FORMATION" id="btnContinua">FORMACIÓN CONTINUA</a>
            <a class="nav-link tab azul_blanco" data-i18n-es="CURSOS DE ESPAÑOL" data-i18n-en="SPANISH COURSES" id="btnCursos">CURSOS DE ESPAÑOL</a>
          </nav>
        </div>
	...
	<!-- CONTACTO -->
	  <div class="container contacto" style="margin-top: 1em;">
		  <div class="row">
				  ...
				  <form method="post" id="formulario_contacto">
					  <div class="form-row align-items-center">
						  ...
						  <div class="col-auto">
							  ...
							  <button tyoe="submit" id="formulario_contacto_enviar" class="btn btn-primary mb-2" data-i18n-es="enviar" data-i18n-en="send">enviar</button>
						  </div>
