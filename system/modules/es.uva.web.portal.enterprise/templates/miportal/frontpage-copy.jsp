...
<html lang="${cms.locale}" dir="ltr">
  ...
  <body>
      ...
      <div class="row align-items-center">
        ...
        <div class="col">
          ...
          <div class="user_icons">
            <div class="icons_up">
			<span class="icon_group"><a href="<cms:link>/misdatos.html</cms:link>" role="link"><span class="icon_description">Mis datos</span></a> <i class="fas fa-user-circle"></i></span>
	...
	<miportal-grupos data="./ws/info.jsp" data-perfil=""></miportal-grupos>
	...
	<link rel="import" id="template_miportal" href="./templates/elemento-miportal.html"	onload="handleLoad(event)" onerror="handleError(event)">
	
	
	<script src="<cms:link>/system/modules/es.uva.web.portal.enterprise/resources/miportal/js/miportalStorage.js</cms:link>"></script>
	...
	<script src="<cms:link>/system/modules/es.uva.web.portal.enterprise/resources/miportal/js/worker.js</cms:link>"></script>
